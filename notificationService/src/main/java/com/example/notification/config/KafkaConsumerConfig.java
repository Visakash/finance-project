...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, LoanEvent> consumerFactory() {
		...
		config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, LoanEvent.class.getName());
		return new DefaultKafkaConsumerFactory<>(config);
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, LoanEvent> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, LoanEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
